...
import ru.mixail_akulov.my.englishtrain.multimodule.core.AlertDialogConfig
import ru.mixail_akulov.my.englishtrain.multimodule.core.CommonUi
import kotlin.coroutines.resume

/**
 * Реализация [CommonUi] по умолчанию для отображения всплывающих уведомлений и диалогов.
 * Диалоги отображаются только при запуске активности.
 * В противном случае они откладываются.
 */
