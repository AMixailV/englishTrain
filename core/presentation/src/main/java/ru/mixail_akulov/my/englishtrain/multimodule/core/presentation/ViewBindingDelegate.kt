...
/**
 * Создавайте и удерживайте класс [ViewBinding] только тогда,
 * когда представление фрагмента существует и не уничтожается
 * (после onCreateView и перед обратными вызовами onDestroyView).
 *
 * Usage example:
 *
 * ```
